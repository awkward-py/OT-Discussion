...
{["user_2mWKGv1qqkFoVZiERSgQYsSom2B", "user_2n5xdgqdECnSabJtgQjgvyWL2Ch"].includes(answer.author.clerkId) && (
  <svg
    ...
    style={{ display: 'block' }} // Ensure the SVG is not hidden
  >
    <defs>
      <linearGradient id="gold-a-unique" x1="4.411" x2="18.083" y1="2.495" y2="21.508">
      ...
      <linearGradient id="gold-b-unique" x1="5.355" x2="16.361" y1="3.395" y2="19.133">
