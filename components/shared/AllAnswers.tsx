...
{["user_2mnrfhoM9HBMIi3aN3HAscS2mvI" ,  "user_2mZDAsYeSh6weP5IoPoJalgbr8s", "user_2mq8dxfCaSckEyismGK4OWWprvi", "user_2mbIauEsU875Pp50WflTE8icx1n"].includes(answer.author.clerkId) && (
  <svg
    aria-label="Verified"
    fill="rgb(0, 149, 246)"
    height="14"
