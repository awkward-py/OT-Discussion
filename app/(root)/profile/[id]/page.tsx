        ...
        <div className="flex flex-col items-start gap-4 lg:flex-row">
          ...
          <div className="mt-3">
           ...
           {['user_2msC45rbo2Xcfzx3Qs5aa5Z9UOe', 'user_2n5xdgqdECnSabJtgQjgvyWL2Ch'].includes(userInfo.user.clerkId) && (
              ...
              {['user_2mnrfhoM9HBMIi3aN3HAscS2mvI','user_2mbIauEsU875Pp50WflTE8icx1n', 'user_2mZ9MjK0ARsTPzJZUyEC0MWzmf4' , 'user_2mxdwEQX81YYzm0dEZZOTkZAEQy'].includes(userInfo.user.clerkId) && (
                <svg
                  aria-label="Verified"
                  fill="rgb(0, 149, 246)"
                  height="14"
